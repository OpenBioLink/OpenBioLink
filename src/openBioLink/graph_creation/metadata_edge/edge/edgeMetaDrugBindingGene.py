...
from openbiolink.graph_creation.metadata_infile import InMetaEdgeStitchBinding
...
class EdgeMetaDrugBindingGene(EdgeRegularMetadata):
    NAME = 'Edge - Drug_binding_Gene'

    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700

    EDGE_INMETA_CLASS = InMetaEdgeStitchBinding
