...
from graph_creation.metadata_infile import InMetaEdgeStringReaction
from graph_creation.metadata_infile.mapping.inMetaMapString import InMetaMapString


class EdgeMetaGeneReactionGene(EdgeRegularMetadata):
    NAME = 'Edge - Gene_reaction_Gene'

    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700

    EDGE_INMETA_CLASS = InMetaEdgeStringReaction
