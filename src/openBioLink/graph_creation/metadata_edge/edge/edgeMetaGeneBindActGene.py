...
from graph_creation.metadata_infile import InMetaEdgeStringBindAct
from graph_creation.metadata_infile.mapping.inMetaMapString import InMetaMapString


class EdgeMetaGeneBindActGene(EdgeRegularMetadata):
    NAME = 'Edge - Gene_binding/activation_Gene'

    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700

    EDGE_INMETA_CLASS = InMetaEdgeStringBindAct
