...
from openbiolink.graph_creation.metadata_infile import InMetaEdgeStitchActivation
...
class EdgeMetaDrugActivationGene(EdgeRegularMetadata):
    NAME = 'Edge - Drug_activation_Gene'

    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700

    EDGE_INMETA_CLASS = InMetaEdgeStitchActivation
