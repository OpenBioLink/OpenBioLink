...
from ...metadata_infile import InMetaEdgeStitchCatalysis
from ...metadata_infile.mapping.inMetaMapString import InMetaMapString


class EdgeMetaDrugCatalysisGene(EdgeRegularMetadata):
    NAME = 'Edge - Drug_catalysis_Gene'

    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700

    EDGE_INMETA_CLASS = InMetaEdgeStitchCatalysis
