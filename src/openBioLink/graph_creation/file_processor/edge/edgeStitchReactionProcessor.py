...
from openbiolink.graph_creation.metadata_infile import InMetaEdgeStitchReaction
from openbiolink.graph_creation.types.infileType import InfileType
from openbiolink.graph_creation.types.readerType import ReaderType


class EdgeStitchReactionProcessor(FileProcessor):
    IN_META_CLASS = InMetaEdgeStitchReaction

    def __init__(self):
        self.use_cols = self.IN_META_CLASS.USE_COLS
        super().__init__(self.use_cols, readerType=ReaderType.READER_EDGE_STITCH_ACTION,
                         infileType=InfileType.IN_EDGE_STITCH_REACTION, mapping_sep=self.IN_META_CLASS.MAPPING_SEP)
