...
from openbiolink.graph_creation.metadata_db_file.edge.dbMetaEdgeSiderInd import (
    DbMetaEdgeSiderInd,
)
...
class EdgeSiderIndReader(CsvReader):
    DB_META_CLASS = DbMetaEdgeSiderInd
    ...
    def __init__(self):
        super().__init__(
            ...
            dtypes=None,
            readerType=ReaderType.READER_EDGE_SIDER_IND,
