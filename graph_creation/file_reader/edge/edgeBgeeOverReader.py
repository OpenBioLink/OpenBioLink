...
from graph_creation.metadata_db_file.edge.dbMetaEdgeBgeeOverExpr import DbMetaEdgeBgeeOverExpr
import graph_creation.globalConstant as g
import os


class EdgeBgeeOverReader(CsvReader):

    def __init__(self):
        self.dbMetaClass = DbMetaEdgeBgeeOverExpr
        super().__init__(
        ...
        nr_lines_header = self.dbMetaClass.HEADER,
            readerType= ReaderType.READER_EDGE_BGEE_OVER
        )
