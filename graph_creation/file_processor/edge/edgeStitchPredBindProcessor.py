...
from graph_creation.metadata_infile import InMetaEdgeStitchPredBind


class EdgeStitchPredBindProcessor(FileProcessor):

    META_EDGE_CLASS = InMetaEdgeStitchPredBind

    def __init__(self):
        self.use_cols = self.META_EDGE_CLASS.USE_COLS
        super().__init__(self.use_cols, readerType=ReaderType.READER_EDGE_STITCH_ACTION,
                         infileType=InfileType.IN_EDGE_STITCH_PREDBIND, mapping_sep=self.META_EDGE_CLASS.MAPPING_SEP)
