...
from graph_creation.metadata_infile import InMetaEdgeStringBindAct, InMetaEdgeStringBinding
from graph_creation.metadata_infile.mapping.inMetaMapString import InMetaMapString


class EdgeMetaGeneBindingGene(EdgeMetadata):
    LQ_CUTOFF = 0
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700
    LQ_CUTOFF_TEXT = None
    ...
    def __init__(self, quality : QualityType= None):
        ...
        self.EdgesMetaClass = InMetaEdgeStringBinding
