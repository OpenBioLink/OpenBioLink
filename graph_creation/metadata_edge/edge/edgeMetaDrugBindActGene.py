...
from graph_creation.metadata_infile import InMetaEdgeStitchBinding, InMetaEdgeStitchBindAct
from graph_creation.metadata_infile.mapping.inMetaMapString import InMetaMapString


class EdgeMetaDrugBindActGene(EdgeMetadata):
    LQ_CUTOFF = 0 #todo
    MQ_CUTOFF = 400
    HQ_CUTOFF = 700
    LQ_CUTOFF_TEXT = None
    ...
    def __init__(self, quality : QualityType= None):
        ...
        self.EdgesMetaClass = InMetaEdgeStitchBindAct
