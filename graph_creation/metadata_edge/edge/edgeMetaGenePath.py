...
import graph_creation.constants.in_file.edge.inEdgeCdtPathConstant as edgeConst
import graph_creation.constants.edge_file.edge.edgeEdgeGenePathConstant as const
...
class EdgeMetaGenePath(EdgeMetadata):
    def __init__(self, quality : QualityType):
        ...
        super().__init__(edges_file_path=edges_file_path,
                         colindex1=0, colindex2=1, edgeType=EdgeType.GENE_PATHWAY,
